...
public class FPSController : MonoBehaviour
{
    ...
    Quaternion m_cameraRot, m_characterRot;
    float m_xSensityvity = 3f, m_ySensityvity = 3f; //sensityvity(感度)

    private float m_jumpPower; //主人公のジャンプ用
    private bool m_isJumping = false; //主人公がジャンプしているかを判断する
    private Rigidbody m_rigidbody;

    bool m_cursorLock = true; //マウスカーソルを画面中央に固定しているかを判断する
    float m_camAngMaxX = 70f, m_camAngMinX = -70f; //カメラ角度の制限
